                ...
                <>
                    ...
                    <div className="text-center pt-24">
                        ...
                        <p className="text-5xl text-teal-600 font-bold">
                            {(dashboard.household + dashboard.transportation + dashboard.lifestyle).toFixed(2)}{' '}
                    ...
                    <div className="flex flex-col items-center justify-center w-full bg-gray-50 pt-10 pb-20">
                        <h2 className="text-3xl font-bold text-teal-700 mb-5">Steps You Need To Follow To Reduce Your Carbon Footprint</h2>
