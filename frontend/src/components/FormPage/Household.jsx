        ...
        <div>
            <div className="max-w-md mx-auto bg-white p-8 rounded-md shadow-md">
                ...
                <div className="mb-4">
                    ...
                    <input type="number" id="cleanEnergyPercentage" name="cleanEnergyPercentage" value={household.cleanEnergyPercentage} onChange={handleChange} className="w-full px-4 py-2 border rounded-md" />
                </div>
                <div className="mb-4">
